...
async function get_result(input_array, gameStartSeed) {
    ...
    if (search_result == btree || search_result.output == 0) {
        ...
        //æ€»ä¹‹å°±æ˜¯æ²¡æœ‰æŸ¥åˆ°å›ºå®šç»„åˆ
        //ä¸­é—´æ˜¯ä¸€ç³»åˆ—ç®—æ³•
        ...
        while (true) {
            ...
            let item_config = GetItemConfig(itemdata, selected)
