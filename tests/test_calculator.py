...
class TestCraftingCalculator:

    @pytest.mark.parametrize("seed_string,pickups,correct_id", [
        ("7bvmyw7d", pickup_names_to_list([
            "Red Heart",
            "Red Heart",
            "Soul Heart",
            "Soul Heart",
    ...
    def test_calculation(self, seed_string, pickups, correct_id):
        ...
        item_id, quality_sum = get_result(pickups, seed)
